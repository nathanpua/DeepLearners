      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <a href="#" className="hover:text-blue-200 transition-colors hidden md:inline">About</a>
            <a href="#" className="hover:text-blue-200 transition-colors hidden md:inline">Resources</a>
            <a href="#" className="hover:text-blue-200 transition-colors hidden md:inline">FAQ</a>
